/**
 * Clase Pruebas, contiene los metodos para probar los ejemplos de manejo de pilas, colas y Stack
 *
...
public class Pruebas {
     ...
     * en el texto
     */
    private final ListaEtiquetas lista;

    /**
     * Constructor de la clase
     * Prepara la lista de etiquetas que vamos a poder utilizar en los distintos metodos
     */
    public Pruebas () {
    ...
    /**
     * Metodo que contiene las pruebas que vamos a realizar de los metodos a desarrollar en la
    ...
    public void pruebasPila () {
        ...
        System.out.println("\nEjemplo1:");
        boolean resultado = pruebasPila.comprobarLinea(lista,linea);
        System.out.println("Resultado: "+resultado);

        linea = ejemplo2();
        System.out.println("\nEjemplo2:");
        resultado = pruebasPila.comprobarLinea(lista, linea);
        System.out.println("Resultado: "+resultado);
    ...
    /**
     * Metodo que contiene las pruebas que vamos a realizar de los metodos a desarrollar en la
     * clase UtilizacionColas, que manejaran una cola
     */
    ...
    /**
     * Metodo que contiene las pruebas que vamos a realizar de los metodos a desarrollar en la
     * clase UtilizacionColas, que manejaran tanto una pila como una cola
     */
    ...
    /**
     * Metodo que llama a los anteriores (pruebasPila, pruebas Stack, pruebasCola
